...
namespace Api.Data.Migrations
{
    ...
    [Migration("20260919094858_ExtendLienTracabiliteEtPrioriteMoSCoW")]
    partial class ExtendLienTracabiliteEtPrioriteMoSCoW
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Data.Entities.LienTracabilite", b =>
                {
                    ...
                    b.Property<int?>("InformationRegistreId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("InformationRegistreId");

                    b.HasIndex("ProblemeId");

                    b.ToTable("LiensTracabilite", t =>
                        {
                            t.HasCheckConstraint("CK_LienTracabilite_AuMoinsUnLien", "\"ProblemeId\" IS NOT NULL OR \"FonctionnaliteId\" IS NOT NULL OR \"EntiteId\" IS NOT NULL OR \"CritereAcceptationId\" IS NOT NULL OR \"InformationRegistreId\" IS NOT NULL");
                        });
                });
            ...
            modelBuilder.Entity("Api.Data.Entities.LienTracabilite", b =>
                {
                    ...
                    b.HasOne("Api.Data.Entities.InformationRegistre", "InformationRegistre")
                        .WithMany()
                        .HasForeignKey("InformationRegistreId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.Navigation("InformationRegistre");
